...
float my_brent(double ax, double bx, double cx,
...
void my_derivs(double x, double y[], double dydx[]);
...
void my_eigsrt(double d[],double **v, int n);
...
void my_gaussj(double **a, int n, double **b, int m);
...
void my_indexx(unsigned long n, double arr[], unsigned long indx[]);
void interp(double **uf, double **uc, int nf);
int irbit1(unsigned long *iseed);
int irbit2(unsigned long *iseed);
void jacobi(float **a, int n, float d[], float **v, int *nrot);
void my_jacobi(double **a, int n, double d[], double **v, int *nrot);
...
void my_locate(double  xx[], unsigned long n, double  x, unsigned long *j);
void locate(float xx[], unsigned long n, float x, unsigned long *j);
void lop(double **out, double **u, int n);
void lubksb(float **a, int n, int *indx, float b[]);
void ludcmp(float **a, int n, int *indx, float *d);
void my_ludcmp(double **a, int n, int *indx,  double *d);
...
void my_moment(double data[], int n, double *ave, double *adev, double *sdev,
...
void my_rkck(double y[], double dydx[], int n, double x, double h,
	double yout[], double yerr[], void (*my_derivs)(double, double [], double []));
...
float rtsafe(void (*funcd)(float, float *, float *), float x1, float x2,
	float xacc);
double my_rtsafe(void (*funcd)(double, double *, double *), double x1, double x2,
	double xacc);
...
void my_sort(unsigned long n, double arr[]);
void my_sort2(unsigned long n, double arr[], double brr[]);
void my_sort3(unsigned long n, double ra[], double rb[], double rc[]);
...
void my_splie2(double x1a[], double x2a[], double **ya, int m, int n, double **y2a);
void my_splin2(double x1a[], double x2a[], double **ya, double **y2a, int m, int n,
	double x1, double x2, double *y);
void spline(float x[], float y[], int n, float yp1, float ypn, float y2[]);
void splint(float xa[], float ya[], float y2a[], int n, float x, float *y);
void my_spline(double x[], double y[], int n, double yp1, double ypn, 
	       double y2[]);
void my_splint(double xa[], double ya[], double y2a[], int n, double x, 
	       double *y);
